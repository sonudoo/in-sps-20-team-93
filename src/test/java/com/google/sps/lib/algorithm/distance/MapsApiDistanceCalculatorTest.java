  ...
  public void findDistance_successresponse_requestUrlAsExpected() throws Exception {
    ...
    List<Coordinate> coordinates = new ArrayList<>(
                                     Arrays.asList(new Coordinate(28.6129, 77.2295),
                                                   new Coordinate(22.5726, 88.3639),
                                                   new Coordinate(19.0760, 72.8777)));
    String expectedRequestUrl = "https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origin=28.6129,77.2295|22.5726,88.3639|19.0760,72.8777&destinations=28.6129,77.2295|22.5726,88.3639|19.0760,72.8777&key=__GOOGLE_MAPS_API_KEY__";
    
    double distanceMatrix[][] = new MapsApiDistanceCalculator(mockUrlWrapper).findDistance(coordinates);

    verify(mockUrlWrapper.openConnection(expectedRequestUrl), times(1));
  }
}